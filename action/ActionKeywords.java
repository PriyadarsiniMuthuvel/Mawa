...
public class ActionKeywords {
	...
	public static void getVolunteerID_Xpath(String ElementID,String data, WebDriver driver) throws InterruptedException{
		try{
			presenceOfElementXpath(ElementID,data,driver);		
			WebElement element = driver.findElement(By.xpath(ElementID));
			String value = element.getText();
	...
	public static boolean click_SFContact(String ElementID, String text,WebDriver driver){
		try{
			WebElement table = driver.findElement(By.cssSelector(ElementID));
	...
	try{
            ...
            for(int row=1; row<=rows_count; row++){
                  ...
                  if(text.equals(relationValue)){
                         ...
                         int Expected_AvailableSeat = Integer.parseInt(col_table.get(7).getText())-1;
                         int Actual_AvailableSeat = Integer.parseInt(col_table.get(8).getText());
	...
	public static boolean verifyRegisterAvailableSeatCounts_orientation(String ElementID, String text,WebDriver driver){
		try{
	            WebElement table = driver.findElement(By.cssSelector(ElementID));
	...
	public static boolean verifyDropdown(String ElementID, String data,WebDriver driver) throws Exception{
		try{
			...
			if(value.equals(data)){
				...
				throw new CustomException("The status of the application " + value + "is not matched with the excel value.");
			}
		}
		...
		public static void MouseHover(String ElementID, String text,WebDriver driver) throws Exception{
			...
			WebElement E = (new WebDriverWait(driver, 15))
			 ...
			 if(driver.findElement(By.cssSelector(Element2)).isDisplayed()){
				...
				System.out.println("ToolTip Text Verified");
			}}
			else{
					...
					{  
					 ...
					 if(from.equals(from_email)){
				    	 ...
				    	 if(subject_email.contains(subject)){
				    		 ...
				    		 if (content.contains(parsed_content)){
				    			 i = count;
				    			 bool = true;
				     		}
				    	 }	 	
